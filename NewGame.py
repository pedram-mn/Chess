...
def Start():
    ...
    k_b = pg.image.load("b\\shah b.png")
    ##############################################
    ...
    k_w = pg.image.load("w\\shah w.png")
    ##############################################
    pos_b = {"sarbaz_b1": [189, 478], "sarbaz_b2": [259, 478], "sarbaz_b3": [329, 478], "sarbaz_b4": [399, 478],
             "sarbaz_b5": [471, 478], "sarbaz_b6": [542, 478], "sarbaz_b7": [612, 478], "sarbaz_b8": [682, 478],
             "rokh_b1": [189, 541], "rokh_b2": [682, 541], "asb_b1": [259, 541], "asb_b2": [612, 541],
             "fil_b1": [329, 541],
             "fil_b2": [542, 541], "vazir_b": [400, 541], "k_b": [471, 541]}
    pos_w = {"sarbaz_w1": [189, 163], "sarbaz_w2": [259, 163], "sarbaz_w3": [329, 163], "sarbaz_w4": [399, 163],
             "sarbaz_w5": [471, 163], "sarbaz_w6": [542, 163], "sarbaz_w7": [612, 163], "sarbaz_w8": [682, 163],
             "rokh_w1": [189, 102], "rokh_w2": [682, 102], "asb_w1": [259, 100], "asb_w2": [612, 100],
             "fil_w1": [329, 100],
             "fil_w2": [542, 100], "vazir_w": [399, 100], "k_w": [471, 100]}

    sarbaz_b1_move = [[pos_b["sarbaz_b1"][0] + 70, pos_b["sarbaz_b1"][1] - 63],
                      [pos_b["sarbaz_b1"][0] - 70, pos_b["sarbaz_b1"][1] - 63],
                      [pos_b["sarbaz_b1"][0], pos_b["sarbaz_b1"][1] - 63],
                      [pos_b["sarbaz_b1"][0], pos_b["sarbaz_b1"][1] - 126]]
    sarbaz_b2_move = [[pos_b["sarbaz_b2"][0] + 70, pos_b["sarbaz_b2"][1] - 63],
                      [pos_b["sarbaz_b2"][0] - 70, pos_b["sarbaz_b2"][1] - 63],
                      [pos_b["sarbaz_b2"][0], pos_b["sarbaz_b2"][1] - 63],
                      [pos_b["sarbaz_b2"][0], pos_b["sarbaz_b2"][1] - 126]]
    sarbaz_b3_move = [[pos_b["sarbaz_b3"][0] + 70, pos_b["sarbaz_b3"][1] - 63],
                      [pos_b["sarbaz_b3"][0] - 70, pos_b["sarbaz_b3"][1] - 63],
                      [pos_b["sarbaz_b3"][0], pos_b["sarbaz_b3"][1] - 63],
                      [pos_b["sarbaz_b3"][0], pos_b["sarbaz_b3"][1] - 126]]
    sarbaz_b4_move = [[pos_b["sarbaz_b4"][0] + 70, pos_b["sarbaz_b4"][1] - 63],
                      [pos_b["sarbaz_b4"][0] - 70, pos_b["sarbaz_b4"][1] - 63],
                      [pos_b["sarbaz_b4"][0], pos_b["sarbaz_b4"][1] - 63],
                      [pos_b["sarbaz_b4"][0], pos_b["sarbaz_b4"][1] - 126]]
    sarbaz_b5_move = [[pos_b["sarbaz_b5"][0] + 70, pos_b["sarbaz_b5"][1] - 63],
                      [pos_b["sarbaz_b5"][0] - 70, pos_b["sarbaz_b5"][1] - 63],
                      [pos_b["sarbaz_b5"][0], pos_b["sarbaz_b5"][1] - 63],
                      [pos_b["sarbaz_b5"][0], pos_b["sarbaz_b5"][1] - 126]]
    sarbaz_b6_move = [[pos_b["sarbaz_b6"][0] + 70, pos_b["sarbaz_b6"][1] - 63],
                      [pos_b["sarbaz_b6"][0] - 70, pos_b["sarbaz_b6"][1] - 63],
                      [pos_b["sarbaz_b6"][0], pos_b["sarbaz_b6"][1] - 63],
                      [pos_b["sarbaz_b6"][0], pos_b["sarbaz_b6"][1] - 126]]
    sarbaz_b7_move = [[pos_b["sarbaz_b7"][0] + 70, pos_b["sarbaz_b7"][1] - 63],
                      [pos_b["sarbaz_b7"][0] - 70, pos_b["sarbaz_b7"][1] - 63],
                      [pos_b["sarbaz_b7"][0], pos_b["sarbaz_b7"][1] - 63],
                      [pos_b["sarbaz_b7"][0], pos_b["sarbaz_b7"][1] - 126]]
    sarbaz_b8_move = [[pos_b["sarbaz_b8"][0] + 70, pos_b["sarbaz_b8"][1] - 63],
                      [pos_b["sarbaz_b8"][0] - 70, pos_b["sarbaz_b8"][1] - 63],
                      [pos_b["sarbaz_b8"][0], pos_b["sarbaz_b8"][1] - 63],
                      [pos_b["sarbaz_b8"][0], pos_b["sarbaz_b8"][1] - 126]]
    rokh_b1_move = [[pos_b["rokh_b1"][0] + 70, pos_b["rokh_b1"][1]], [pos_b["rokh_b1"][0] + 140, pos_b["rokh_b1"][1]],
                    [pos_b["rokh_b1"][0] + 210, pos_b["rokh_b1"][1]], [pos_b["rokh_b1"][0] + 280, pos_b["rokh_b1"][1]],
                    [pos_b["rokh_b1"][0] + 350, pos_b["rokh_b1"][1]], [pos_b["rokh_b1"][0] + 420, pos_b["rokh_b1"][1]],
                    [pos_b["rokh_b1"][0] + 490, pos_b["rokh_b1"][1]], [pos_b["rokh_b1"][0] - 70, pos_b["rokh_b1"][1]],
                    [pos_b["rokh_b1"][0] - 140, pos_b["rokh_b1"][1]], [pos_b["rokh_b1"][0] - 210, pos_b["rokh_b1"][1]],
                    [pos_b["rokh_b1"][0] - 280, pos_b["rokh_b1"][1]], [pos_b["rokh_b1"][0] - 350, pos_b["rokh_b1"][1]],
                    [pos_b["rokh_b1"][0] - 420, pos_b["rokh_b1"][1]], [pos_b["rokh_b1"][0] - 490, pos_b["rokh_b1"][1]],
                    [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] + 63], [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] + 126],
                    [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] + 189], [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] + 252],
                    [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] + 315], [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] + 378],
                    [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] + 441], [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] - 63],
                    [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] - 126], [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] - 189],
                    [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] - 252], [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] - 315],
                    [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] - 378], [pos_b["rokh_b1"][0], pos_b["rokh_b1"][1] - 441]]
    rokh_b2_move = [[pos_b["rokh_b2"][0] + 70, pos_b["rokh_b2"][1]], [pos_b["rokh_b2"][0] + 140, pos_b["rokh_b2"][1]],
                    [pos_b["rokh_b2"][0] + 210, pos_b["rokh_b2"][1]], [pos_b["rokh_b2"][0] + 280, pos_b["rokh_b2"][1]],
                    [pos_b["rokh_b2"][0] + 350, pos_b["rokh_b2"][1]], [pos_b["rokh_b2"][0] + 420, pos_b["rokh_b2"][1]],
                    [pos_b["rokh_b2"][0] + 490, pos_b["rokh_b2"][1]], [pos_b["rokh_b2"][0] - 70, pos_b["rokh_b2"][1]],
                    [pos_b["rokh_b2"][0] - 140, pos_b["rokh_b2"][1]], [pos_b["rokh_b2"][0] - 210, pos_b["rokh_b2"][1]],
                    [pos_b["rokh_b2"][0] - 280, pos_b["rokh_b2"][1]], [pos_b["rokh_b2"][0] - 350, pos_b["rokh_b2"][1]],
                    [pos_b["rokh_b2"][0] - 420, pos_b["rokh_b2"][1]], [pos_b["rokh_b2"][0] - 490, pos_b["rokh_b2"][1]],
                    [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] + 63], [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] + 126],
                    [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] + 189], [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] + 252],
                    [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] + 315], [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] + 378],
                    [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] + 441], [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] - 63],
                    [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] - 126], [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] - 189],
                    [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] - 252], [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] - 315],
                    [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] - 378], [pos_b["rokh_b2"][0], pos_b["rokh_b2"][1] - 441]]
    asb_b1_move = [[pos_b["asb_b1"][0] + 70, pos_b["asb_b1"][1] + 126],
                   [pos_b["asb_b1"][0] + 140, pos_b["asb_b1"][1] + 63],
                   [pos_b["asb_b1"][0] + 140, pos_b["asb_b1"][1] - 63], 
                   [pos_b["asb_b1"][0] + 70, pos_b["asb_b1"][1] - 126],
                   [pos_b["asb_b1"][0] - 70, pos_b["asb_b1"][1] - 126],
                   [pos_b["asb_b1"][0] - 140, pos_b["asb_b1"][1] - 63],
                   [pos_b["asb_b1"][0] - 140, pos_b["asb_b1"][1] + 63],
                   [pos_b["asb_b1"][0] - 70, pos_b["asb_b1"][1] + 126]]
    asb_b2_move = [[pos_b["asb_b2"][0] + 70, pos_b["asb_b2"][1] + 126],
                   [pos_b["asb_b2"][0] + 140, pos_b["asb_b2"][1] + 63],
                   [pos_b["asb_b2"][0] + 140, pos_b["asb_b2"][1] - 63], 
                   [pos_b["asb_b2"][0] + 70, pos_b["asb_b2"][1] - 126],
                   [pos_b["asb_b2"][0] - 70, pos_b["asb_b2"][1] - 126],
                   [pos_b["asb_b2"][0] - 140, pos_b["asb_b2"][1] - 63],
                   [pos_b["asb_b2"][0] - 140, pos_b["asb_b2"][1] + 63],
                   [pos_b["asb_b2"][0] - 70, pos_b["asb_b2"][1] + 126]]
    fil_b1_move = [[pos_b["fil_b1"][0] + 70, pos_b["fil_b1"][1] + 63],
                   [pos_b["fil_b1"][0] + 140, pos_b["fil_b1"][1] + 126],
                   [pos_b["fil_b1"][0] + 210, pos_b["fil_b1"][1] + 189],
                   [pos_b["fil_b1"][0] + 280, pos_b["fil_b1"][1] + 252],
                   [pos_b["fil_b1"][0] + 350, pos_b["fil_b1"][1] + 315],
                   [pos_b["fil_b1"][0] + 420, pos_b["fil_b1"][1] + 378],
                   [pos_b["fil_b1"][0] + 490, pos_b["fil_b1"][1] + 441],
                   [pos_b["fil_b1"][0] + 70, pos_b["fil_b1"][1] - 63],
                   [pos_b["fil_b1"][0] + 140, pos_b["fil_b1"][1] - 126],
                   [pos_b["fil_b1"][0] + 210, pos_b["fil_b1"][1] - 189],
                   [pos_b["fil_b1"][0] + 280, pos_b["fil_b1"][1] - 252],
                   [pos_b["fil_b1"][0] + 350, pos_b["fil_b1"][1] - 315],
                   ...
                   [pos_b["fil_b1"][0] - 420, pos_b["fil_b1"][1] + 378],
                   [pos_b["fil_b1"][0] - 490, pos_b["fil_b1"][1] + 441]]
    fil_b2_move = [[pos_b["fil_b2"][0] + 70, pos_b["fil_b2"][1] + 63],
                   [pos_b["fil_b2"][0] + 140, pos_b["fil_b2"][1] + 126],
                   [pos_b["fil_b2"][0] + 210, pos_b["fil_b2"][1] + 189],
                   [pos_b["fil_b2"][0] + 280, pos_b["fil_b2"][1] + 252],
                   [pos_b["fil_b2"][0] + 350, pos_b["fil_b2"][1] + 315],
                   [pos_b["fil_b2"][0] + 420, pos_b["fil_b2"][1] + 378],
                   [pos_b["fil_b2"][0] + 490, pos_b["fil_b2"][1] + 441],
                   [pos_b["fil_b2"][0] + 70, pos_b["fil_b2"][1] - 63],
                   [pos_b["fil_b2"][0] + 140, pos_b["fil_b2"][1] - 126],
                   [pos_b["fil_b2"][0] + 210, pos_b["fil_b2"][1] - 189],
                   [pos_b["fil_b2"][0] + 280, pos_b["fil_b2"][1] - 252],
                   [pos_b["fil_b2"][0] + 350, pos_b["fil_b2"][1] - 315],
    ...
    def show():
        ...
        screen.blit(k_b, tuple(pos_b["k_b"]))
        ...
        screen.blit(k_w, tuple(pos_w["k_w"]))
    ...
    def movements(marble):
        def not_in_bw(marble, num):
            ...
            if marble == "rokh_b1":
                ...
                if num in range(21, 28):
                    j = 21
                while j < num:
                    if rokh_b1_move[j] not in pos_w.values() and rokh_b1_move[j] not in pos_b.values():
                        pass
                    else:
                        res[0] = False
                        break
                    j += 1
                if j == num:
                    if rokh_b1_move[j] in pos_b.values():
                        res[1] = False
                    else:
                        pass
            if marble == "rokh_b2":
                ...
                if num in range(21, 28):
                    j = 21
                while j < num:
                    if rokh_b2_move[j] not in pos_w.values() and rokh_b2_move[j] not in pos_b.values():
                        pass
                    else:
                        res[0] = False
                        break
                    j += 1
                if j == num:
                    if rokh_b2_move[j] in pos_b.values():
                        res[1] = False
                    else:
                        pass
            return res
        ...
        if marble == "sarbaz_b1":
            count = []
            if sarbaz_b1_move[0][0] < 682 and sarbaz_b1_move[0][1] > 100 and sarbaz_b1_move[0] in pos_w.values():
                count += [0]
            if sarbaz_b1_move[1][0] > 189 and sarbaz_b1_move[1][1] > 100 and sarbaz_b1_move[1] in pos_w.values():
                count += [1]
            if sarbaz_b1_move[3][1] > 100 and sarbaz_b1_move[2] not in pos_w.values():
                count += [2]
            if pos_b["sarbaz_b1"] == [189, 478] and [189, 415] not in pos_w.values() and [189,
                                                                                          352] not in pos_w.values():
                count += [3]
            for i in count:
                sarbaz_b1.set_alpha(150)
                screen.blit(sarbaz_b1, tuple(sarbaz_b1_move[i]))
                sarbaz_b1.set_alpha(20000)
        if marble == "sarbaz_b2":
            count = []
            if sarbaz_b2_move[0][0] < 682 and sarbaz_b2_move[0][1] > 100 and sarbaz_b2_move[0] in pos_w.values():
                count += [0]
            if sarbaz_b2_move[1][0] > 189 and sarbaz_b2_move[1][1] > 100 and sarbaz_b2_move[1] in pos_w.values():
                count += [1]
            if sarbaz_b2_move[3][1] > 100 and sarbaz_b2_move[2] not in pos_w.values():
                count += [2]
            if pos_b["sarbaz_b2"] == [259, 478] and [259, 415] not in pos_w.values() and [259,
                                                                                          352] not in pos_w.values():
                count += [3]
            for i in count:
                sarbaz_b2.set_alpha(150)
                screen.blit(sarbaz_b2, tuple(sarbaz_b2_move[i]))
                sarbaz_b2.set_alpha(20000)
        if marble == "sarbaz_b3":
            count = []
            if sarbaz_b3_move[0][0] < 682 and sarbaz_b3_move[0][1] > 100 and sarbaz_b3_move[0] in pos_w.values():
                count += [0]
            if sarbaz_b3_move[1][0] > 189 and sarbaz_b3_move[1][1] > 100 and sarbaz_b3_move[1] in pos_w.values():
                count += [1]
            if sarbaz_b3_move[3][1] > 100 and sarbaz_b3_move[2] not in pos_w.values():
                count += [2]
            if pos_b["sarbaz_b3"] == [329, 478] and [329, 415] not in pos_w.values() and [329,
                                                                                          352] not in pos_w.values():
                count += [3]
            for i in count:
                sarbaz_b3.set_alpha(150)
                screen.blit(sarbaz_b3, tuple(sarbaz_b3_move[i]))
                sarbaz_b3.set_alpha(20000)
        if marble == "sarbaz_b4":
            count = []
            if sarbaz_b4_move[0][0] < 682 and sarbaz_b4_move[0][1] > 100 and sarbaz_b4_move[0] in pos_w.values():
                count += [0]
            if sarbaz_b4_move[1][0] > 189 and sarbaz_b4_move[1][1] > 100 and sarbaz_b4_move[1] in pos_w.values():
                count += [1]
            if sarbaz_b4_move[3][1] > 100 and sarbaz_b4_move[2] not in pos_w.values():
                count += [2]
            if pos_b["sarbaz_b4"] == [399, 478] and [399, 415] not in pos_w.values() and [399,
                                                                                          352] not in pos_w.values():
                count += [3]
            for i in count:
                sarbaz_b4.set_alpha(150)
                screen.blit(sarbaz_b4, tuple(sarbaz_b4_move[i]))
                sarbaz_b4.set_alpha(20000)
        if marble == "sarbaz_b5":
            count = []
            if sarbaz_b5_move[0][0] < 682 and sarbaz_b5_move[0][1] > 100 and sarbaz_b5_move[0] in pos_w.values():
                count += [0]
            if sarbaz_b5_move[1][0] > 189 and sarbaz_b5_move[1][1] > 100 and sarbaz_b5_move[1] in pos_w.values():
                count += [1]
            if sarbaz_b5_move[3][1] > 100 and sarbaz_b5_move[2] not in pos_w.values():
                count += [2]
            if pos_b["sarbaz_b5"] == [471, 478] and [471, 415] not in pos_w.values() and [471,
                                                                                          352] not in pos_w.values():
                count += [3]
            for i in count:
                sarbaz_b5.set_alpha(150)
                screen.blit(sarbaz_b5, tuple(sarbaz_b5_move[i]))
                sarbaz_b5.set_alpha(20000)
        if marble == "sarbaz_b6":
            count = []
            if sarbaz_b6_move[0][0] < 682 and sarbaz_b6_move[0][1] > 100 and sarbaz_b6_move[0] in pos_w.values():
                count += [0]
            if sarbaz_b6_move[1][0] > 189 and sarbaz_b6_move[1][1] > 100 and sarbaz_b6_move[1] in pos_w.values():
                count += [1]
            if sarbaz_b6_move[3][1] > 100 and sarbaz_b6_move[2] not in pos_w.values():
                count += [2]
            if pos_b["sarbaz_b6"] == [542, 478] and [542, 415] not in pos_w.values() and [542,
                                                                                          352] not in pos_w.values():
                count += [3]
            for i in count:
                sarbaz_b6.set_alpha(150)
                screen.blit(sarbaz_b6, tuple(sarbaz_b6_move[i]))
                sarbaz_b6.set_alpha(20000)
        if marble == "sarbaz_b7":
            count = []
            if sarbaz_b7_move[0][0] < 682 and sarbaz_b7_move[0][1] > 100 and sarbaz_b7_move[0] in pos_w.values():
                count += [0]
            if sarbaz_b7_move[1][0] > 189 and sarbaz_b7_move[1][1] > 100 and sarbaz_b7_move[1] in pos_w.values():
                count += [1]
            if sarbaz_b7_move[3][1] > 100 and sarbaz_b7_move[2] not in pos_w.values():
                count += [2]
            if pos_b["sarbaz_b7"] == [612, 478] and [612, 415] not in pos_w.values() and [612,
                                                                                          352] not in pos_w.values():
                count += [3]
            for i in count:
                sarbaz_b7.set_alpha(150)
                screen.blit(sarbaz_b7, tuple(sarbaz_b7_move[i]))
                sarbaz_b7.set_alpha(20000)
        if marble == "sarbaz_b8":
            count = []
            if sarbaz_b8_move[0][0] < 682 and sarbaz_b8_move[0][1] > 100 and sarbaz_b8_move[0] in pos_w.values() and \
                    sarbaz_b8_move[0] not in pos_b.values():
                count += [0]
            if sarbaz_b8_move[1][0] > 189 and sarbaz_b8_move[1][1] > 100 and sarbaz_b8_move[1] in pos_w.values() and \
                    sarbaz_b8_move[1] not in pos_b.values():
                count += [1]
            if sarbaz_b8_move[2][1] > 100 and sarbaz_b8_move[2] not in pos_w.values() and sarbaz_b8_move[
                2] not in pos_b.values():
                count += [2]
            if pos_b["sarbaz_b8"] == [682, 478] and [682, 415] not in pos_w.values() and [682,
                                                                                          352] not in pos_w.values() and \
                    sarbaz_b8_move[3] not in pos_b.values():
                count += [3]
            for i in count:
                sarbaz_b8.set_alpha(150)
                screen.blit(sarbaz_b8, tuple(sarbaz_b8_move[i]))
                sarbaz_b8.set_alpha(20000)
        if marble == "rokh_b1":
            count = []
            for i in range(7):
                if rokh_b1_move[i][0] < 682 and not_in_bw(marble, i)[0] and not_in_bw(marble, i)[1]:
                    count += [i]
            for i in range(7, 14):
                if rokh_b1_move[i][0] > 189 and not_in_bw(marble, i)[0] and not_in_bw(marble, i)[1]:
                    count += [i]
            for i in range(14, 21):
                if rokh_b1_move[i][1] < 541 and not_in_bw(marble, i)[0] and not_in_bw(marble, i)[1]:
                    count += [i]
            for i in range(21, 28):
                if rokh_b1_move[i][1] > 100 and not_in_bw(marble, i)[0] and not_in_bw(marble, i)[1]:
                    count += [i]
            for i in count:
                rokh_b1.set_alpha(150)
                screen.blit(rokh_b1, tuple(rokh_b1_move[i]))
                rokh_b1.set_alpha(20000)
        if marble == "rokh_b2":
            count = []
            for i in range(7):
                if rokh_b2_move[i][0] < 682 and not_in_bw(marble, i)[0] and not_in_bw(marble, i)[1]:
                    count += [i]
            for i in range(7, 14):
                if rokh_b2_move[i][0] > 189 and not_in_bw(marble, i)[0] and not_in_bw(marble, i)[1]:
                    count += [i]
            for i in range(14, 21):
                if rokh_b2_move[i][1] < 541 and not_in_bw(marble, i)[0] and not_in_bw(marble, i)[1]:
                    count += [i]
            for i in range(21, 28):
                if rokh_b2_move[i][1] > 100 and not_in_bw(marble, i)[0] and not_in_bw(marble, i)[1]:
                    count += [i]
            for i in count:
                rokh_b2.set_alpha(150)
                screen.blit(rokh_b2, tuple(rokh_b2_move[i]))
                rokh_b2.set_alpha(20000)
